...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực hoạt động chuyên môn, khoa học và công nghệ',
    users:
      'Doanh nghiệp, lãnh đạo quản lý, bộ phận tài chính - kế toán, nhân sự, kinh doanh và vận hành',
    process:
  ...
  },
  {
    ...
    problem:
      'Đáp ứng xu hướng truyền thông đa kênh, tiếp thị đa điểm và quản trị tập trung; Giải quyết nhu cầu cá nhân hóa nội dung và sáng tạo trên đa thiết bị của người dùng; Khắc phục nhược',
    users:
      'Cơ quan báo chí, nhà xuất bản, đài phát thanh - truyền hình, đơn vị sản xuất nội dung và người dùng nội dung số',
    process:
  ...
  },
  {
    ...
    users:
      'Cơ sở nghiên cứu, cơ sở y tế, doanh nghiệp công nghệ sinh học và chuyên gia trong lĩnh vực di truyền, định vị kiểu gen',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'san_xuat',
  },
  {
    ...
    users:
      'Cơ quan quản lý đô thị, chủ đầu tư, doanh nghiệp xây dựng/bất động sản, đơn vị vận hành và người dân/cư dân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'doanh_nghiep',
  ...
  },
  {
    ...
    dev: 'VTS',
    problem:
      'Số hóa toàn diện hiện trạng đô thị để quản trị, phân tích và mô phỏng các kịch bản phát triển, phục vụ ra quyết định chính xác trong quản lý hạ tầng, quy hoạch và giao thông',
    users:
      'Cơ quan quản lý đô thị, chủ đầu tư, doanh nghiệp xây dựng/bất động sản, đơn vị vận hành và người dân/cư dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Số hóa 3D di sản văn hóa và tài nguyên du lịch trên bản đồ số, tích hợp chỉ đường và hướng dẫn du lịch thông minh',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'tai_chinh',
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Xây dựng bảo tàng số 3D tương tác, cho phép tham quan, xem hiện vật và tìm hiểu nội dung trưng bày từ xa',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực giáo dục và Đào tạo; Giáo dục và đào tạo',
  ...
  },
  {
    ...
    dev: 'BnK Solution',
    problem:
      'BnK IDP đóng góp trực tiếp cho kinh tế xanh thông qua việc giảm in ấn, loại bỏ giấy tờ và giảm tiêu thụ năng lượng trong xử lý thủ công',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực giáo',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ người dùng tra cứu, hỏi đáp và tiếp cận thông tin liên quan đến phân bón thông qua trợ lý ảo',
    users:
      'Người dân, nông dân, đại lý, cán bộ kỹ thuật hoặc đơn vị liên quan đến lĩnh vực phân bón',
    process:
  ...
  },
  {
    ...
    problem:
      'Hệ thống cấp mã số ĐVQHNS trực tuyến mức độ 4 (Front end): Là hệ thống cho phép người đại diện (NĐD) tham gia vào hệ thống để thực hiện đăng ký xin cấp mã ĐVQHNS cho 6 loại dịch vụ khác nhau, ngoài ra NĐD còn có thể theo dõi tra cứu các hồ sơ xin cấp mã củ a cá nhân, theo dõi trạng thái hồ sơ đã được nhập, hồ sơ chờ duyệt, hồ sơ đã cấp mã, ngoài ra còn cho phép NĐD có thể in GCN trực tiếp (Có hỗ trợ in mã vạch)',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Hỗ trợ cấp mã số cho các đơn vị sử dụng ngân sách trung ương theo Quyết định số 90/2007/QĐ - BTC ngày 26/10/2007 của Bộ Tài chính về việc ban hành Quy định mã số các đơn vị có quan hệ với ngân sách và Quyết định số',
    users:
  ...
  },
  {
    ...
    dev: 'Trung tâm R&D',
    problem:
      'Tách chương trình phát thanh thành các phần nhỏ (bản tin, chuyên mục, ca nhạc, phỏng vấn)',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'nong_nghiep',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực khoa học và Công nghệ; Hoạt động chuyên môn, khoa học và công nghệ',
    users:
      'Người dùng cuối, cơ quan, tổ chức, doanh nghiệp và bộ phận hỗ trợ khách hàng có nhu cầu hỏi đáp, tra cứu thông tin',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'doanh_nghiep',
  },
  {
    ...
    problem:
      'Khi tiện ích này đi vào hoạt động sẽ giúp giảm áp lực cho cán bộ tiếp dân. Giúp người dân chủ động tra cứu',
  ...
  },
  {
    ...
    dev: 'VNPT Hải Phòng',
    problem:
      '1. Chatbot AI trên Cổng thông tin điện tử (Website) Đây là "trợ lý ảo" trực tiếp ngay tại trang chủ, giúp người dân định hướng nhanh chóng trong biển thông tin hành chính. Tra cứu thủ tục hành chính (TTHC): Tự động hướng dẫn các thành phần hồ sơ, quy trình thực hiện, lệ phí và thời gian trả kết quả cho từng lĩnh vực (tư pháp, hộ tịch, đất đai…)',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'Trung tâm R&D',
    problem:
      'Cung cấp công cụ chuyển đổi nhanh giọng nói thành văn bản phục vụ biên tập, lưu trữ, tìm kiếm',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực khoa học và Công nghệ; Giáo dục và Đào tạo',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    problem:
      'Hệ thống Quản lý văn bản điều hành được xây dựng theo mô hình tập trung, triển khai cho các đơn vị trong hệ thống KBNN đáp ứng được các quy định tại: Quyết định số',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Do hệ thống TABMIS chưa đáp ứng được yêu cầu quản lý riêng về tình hình thực hiện và thanh toán vốn đầu tư công (như báo cáo',
  ...
  },
  {
    ...
    problem:
      'Thực tế tại Việt Nam cho thấy số lượng doanh nghiệp, hộ kinh doanh và cá nhân tham gia giao dịch điện tử ngày càng tăng, đặc biệt dưới tác động của các quy định bắt buộc như sử dụng hóa đơn điện tử và kê',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp hạ tầng điện toán đám mây (máy chủ ảo, lưu trữ, mạng) theo mô hình IaaS linh hoạt, thanh toán theo dùng',
    users:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Vận hành, quản trị và tối ưu hóa toàn bộ môi trường cloud của khách hàng bởi đội ngũ chuyên gia Viettel',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cấp phép nền tảng Cloud Platform để tổ chức tự xây dựng và vận hành hạ tầng Private Cloud tại trung tâm dữ liệu riêng',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp nền tảng đám mây PaaS (Kubernetes, Container Registry, Database - as - a - Service) để phát triển và vận hành ứng dụng',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Bảo vệ toàn diện dữ liệu, ứng dụng và hạ tầng trên môi trường đám mây trước các mối đe dọa an ninh mạng',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ an toàn thông tin, quản trị hệ thống và bộ phận công nghệ thông tin',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực hoạt động viễn thông; lập trình máy tính, tư vấn, cơ sở hạ tầng máy tính và các dịch vụ thông tin khác',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Người dung cá nhân Việt Nam liên tục nằm trong top quốc gia có tỷ lệ lây nhiễm mã độc cao tại châu Á; hàng triệu thiết bị bị tấn công mỗi năm gây thiệt hại hàng nghìn tỷ đồng. CMC AV sẽ là lá chắn số giúp bảo vệ mỗi người dân khỏi',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và người dùng nội bộ',
    process:
  ...
  },
  {
    ...
    dev: 'CMC Cyber Security',
    problem:
      'Tấn công APT do nhóm hacker nhà nước bảo trợ nhắm hạ tầng quan trọng Việt Nam (điện lực, viễn thông, tài chính, quốc phòng) ngày càng tinh vi. Thời gian phát hiện xâm nhập trung bình tại VN kéo dài hàng tháng đến hàng năm, gây thiệt hại kép. CMC EDR rút ng ắn MTTD & MTTR, hỗ trợ điều tra số (Digital Forensics) phục vụ xử lý sự cố',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ an toàn thông tin, quản trị hệ thống và bộ phận công nghệ thông tin',
    process:
  ...
  },
  {
    ...
    dev: 'CMC Cyber Security',
    problem:
      'Với hơn 72 triệu người dùng smartphone (~73% dân số), Việt Nam là thị trường di động lớn với tỷ lệ tấn công qua app di động ngày càng tăng. Cán bộ, công chức, nhân viên xử lý thông tin liên quan đến doanh nghiệp, cơ quan nhà nước trên smartphone, trong khi ứng dụng giả mạo, spyware, smishing ngày càng tinh vi',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ an toàn thông tin, quản trị hệ thống và bộ phận công nghệ thông tin',
    process:
  ...
  },
  {
    ...
    dev: 'CMC Cyber Security',
    problem:
      'Tình trạng giả mạo ứng dụng dịch vụ công, ngân hàng và tài chính ngày càng gia tăng với các thủ đoạn tinh vi, khó phát hiện. Song song đó, các phần mềm gián điệp tiên tiến',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    dev: 'CMC Cyber Security',
    problem:
      'Việt Nam thiếu một hệ sinh thái chia sẻ thông tin tình báo mối đe dọa (CTI) nội địa; phần lớn tổ chức vẫn ứng phó bị động. Các nhóm APT nhắm VN (APT32/OceanLotus, APT41) liên tục thay đổi TTP, đòi hỏi thông tin tình báo chuyên biệt cập nhật',
    users:
      'Cơ quan quản lý đô thị, chủ đầu tư, doanh nghiệp xây dựng/bất động sản, đơn vị vận hành và người dân/cư dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ số hóa, tối ưu hóa hoạt động dạy và học thông qua hệ thống học tập ứng dụng trí tuệ nhân tạo',
    users:
      'Học sinh, sinh viên, giáo viên, phụ huynh và cơ sở giáo dục có nhu cầu sử dụng hệ thống học tập AI - first',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp không gian vật lý tại Data Center chuẩn Tier cho tổ chức đặt máy chủ riêng, không tự xây dựng hạ tầng',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Quản lý CCVC giải quyết; Quản lý hồ sơ dùng; Quản lý CCVC; Quản lý quá trình lao động; Quản lý bảo hiểm, đào tạo, thi tuyển xét tuyển cán bộ.',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
  ...
  },
  {
    ...
    dev: 'Tổng công ty giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp siêu ứng dụng (super app) để người dân và doanh nghiệp tương tác với chính quyền, truy cập dịch vụ công số',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'cung cấp dữ liệu minh bạch về dự toán, quyết toán, tình hình thực hiện ngân sách trung ương, địa phương và báo cáo ngân sách dành cho công dân, nhằm tăng cường giám sát xã hội',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Tiếp nhận, tích hợp, kết nối, chia sẻ các dịch vụ công trực tuyến của BTC với cổng dịch vụ công quốc gia',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    users:
      'Lực lượng Công an, cán bộ xử lý nghiệp vụ, cơ quan nhà nước, người dân và tổ chức có liên quan',
    process:
  ...
  },
  {
    ...
    problem:
      'Phục vụ kết nối dịch vụ chứng thực chữ ký số công cộng với các hệ thống thông tin phục vụ giao dịch điện tử sử dụng chữ ký số để bảo đảm tính xác thực, tính toàn vẹn và tính chống chối bỏ của thông điệp dữ liệu',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    problem:
      'Kết nối, gửi nhận văn bản và phản hồi trạng thái xử lý văn bản với trục liên thông văn bản quốc gia',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem: 'Hỗ trợ số hóa, chuẩn hóa và dùng chung các nghiệp vụ trong ngành, lĩnh vực',
    users:
      'Cơ quan tư pháp, cán bộ xử lý nghiệp vụ, người dân, doanh nghiệp và tổ chức có liên quan',
    process:
      'Theo danh mục chính thức; quy trình nghiệp vụ cụ thể do cơ quan chủ quản/chủ trì xác định khi triển khai, vận hành',
    cat: 'chinh_quyen',
    field: 'du_lieu',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Quảng bá và cung cấp thông tin du lịch địa phương qua cổng thông tin thông minh, hỗ trợ du khách tra cứu dịch vụ',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Cổng thông tin điện tử nội bộ Học viện Tư pháp duy trì thực hiện nhiệm vụ khai thác các ứng dụng công nghệ trong điều kiện cho phép về mặt kỹ thuật để đảm bảo là kênh thông tin quảng bá hình ảnh, trao đổi và cung cấp tin tức về hoạt động của Học viện Tư ph áp, thông tin phục vụ hoạt động đào tạo, bồi dưỡng',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Bộ Tài chính',
    problem:
      'Hỗ trợ giải quyết thủ tục hành chính, tương tác với người dân, doanh nghiệp và chuẩn hóa kênh cung cấp dịch vụ số',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Theo danh mục chính thức; quy trình nghiệp vụ cụ thể do cơ quan chủ quản/chủ trì xác định khi triển khai, vận hành',
  ...
  },
  {
    ...
    problem:
      'Hệ thống giúp các nhà quản lý (Sở giáo dục, xã phường, cơ sở giáo dục) quản lý thông tin, đăng tải chia sẻ dữ liệu một cách nhanh chóng. Giúp các đơn vị trường học truyền tải thông tin hữu ích đến với',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Hệ thống hóa các quy phạm pháp luật QPPL đang còn hiệu lực do các cơ quan nhà nước ở Trung ương ban hành (trừ Hiến pháp), nhằm tạo điều kiện thuận lợi cho việc tra cứu, áp dụng pháp luật',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem: 'Phục vụ công việc',
    users:
      'Doanh nghiệp bán buôn, bán lẻ, nhà cung cấp, bộ phận kinh doanh và khách hàng mua sắm, tiêu dùng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
    field: 'du_lieu',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Là kênh cung cấp thông tin chính thống, là điểm truy cập của Tổng cục Thi hành án dân sự trên môi trường mạng',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp Doanh nghiệp Viettel',
    problem:
      'Cung cấp cổng thông tin điện tử ngành y tế và giáo dục, phục vụ thông tin, tuyên truyền và điều hành theo mô hình tập trung',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Cung cấp các văn bản chỉ đạo, điều hành của Bộ; giới thiệu về chức năng, nhiệm vụ, tổ chức bộ máy của Bộ Tài chính; thông tin về hoạt động hàng ngày của Bộ Tài',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Cổng thông tin điện tử của Bộ Khoa học và Công nghệ là kênh thông tin chính thức, cung cấp thông tin, dịch vụ công trực tuyến và',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Cổng Thông tin điện tử Bộ Tư pháp là kênh cung cấp thông tin chính thống, là điểm truy cập của Bộ Tư pháp trên môi trường mạng; liên kết, tích hợp với kênh thông tin, các dịch vụ và ứng dụng mà qua đó người dùng có thể khai thác, sử dụng và cá nhân hóa hiể n thị',
    users:
      'Cơ quan tư pháp, cán bộ xử lý nghiệp vụ, người dân, doanh nghiệp và tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Đăng tải chủ trương, chính sách, văn bản pháp luật, thông báo, tin tức hoạt động của Bộ; Giúp người dân và tổ chức tiếp cận thông tin minh bạch, chính xác',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Cung cấp thông tin chính thức về Cục Sở hữu trí tuệ và các hoạt động trong lĩnh vực sở hữu trí tuệ',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'Cổng Thông tin điện tử Cục Dự trữ Nhà nước nhằm cung cấp, tuyên truyền thông tin về hoạt động của Cục và ngành Dự trữ Nhà nước, phục vụ công tác quản lý, điều hành',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    problem:
      'Cổng là kênh thông tin chính thức của Hội cung cấp thông tin tuyên truyền hoạt động Hội và thông tin dành cho cán bộ, hội viên, phụ nữ. Cổng bao gồm hệ thống quản lý đăng nhập trung các phần mềm nội bộ của Hội',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Cung cấp các văn bản chỉ đạo, điều hành của Bộ; giới thiệu về chức năng, nhiệm vụ, tổ chức bộ máy của Bộ Tài chính; thông tin về hoạt động hàng ngày của Bộ Tài chính về các lĩnh vực thuộc chức năng, nhiệm vụ của Bộ Tài chính và các thông tin tham khảo liên quan.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Tạo nền tảng số thống nhất, hiện đại để triển khai công tác phổ biến, giáo dục pháp luật (PBGDPL) trên phạm vi toàn quốc',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'VNPT',
    problem:
      'Công khai, minh bạch thông tin ngành y tế; Cung cấp kênh tra cứu thông tin cho người dân; Kết nối thông tin giữa Sở Y tế và các đơn vị trực thuộc; Hỗ trợ triển khai các dịch vụ y tế trực tuyến.',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    problem:
      'Cổng thông tin tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng để kết nối, tiếp nhận toàn bộ thông tin về chi phí khám, chữa bệnh BHYT và',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Chuẩn hóa, hiện đại hóa trong đào tạo, nâng cao năng lực cho cán bộ công chức; Kiến thức Quản lý nhà nước; nâng cao kỹ năng số và chuyển đổi số; nâng cao kỹ năng mềm và thực thi công vụ; xử lý chuyên ngành.',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    problem:
      'Dùng để gửi và nhận văn bản, xử lý văn bản trên môi trường mạng; Dùng để nhập dữ liệu viên chức,',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nội vụ',
  ...
  },
  {
    ...
    dev: 'Vụ Bưu chính',
    problem:
      '1. Quản lý thông tin cấp phép doanh nghiệp bưu chính; 2. Quản lý thông tin Tem bưu chính',
    users: 'Cơ quan nhà nước, cán bộ xử lý nghiệp vụ, người dân và doanh nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Tập hợp các danh mục được phân loại, kiểm tra, đánh giá, xử lý, tích hợp, số hóa, chuẩn hóa và sắp xếp, lưu trữ một cách hệ thống để cập nhật, khai thác và sử dụng trong lĩnh vực Tài chính thông qua phương tiện điện tử',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Bộ Công an',
    problem:
      'Khắc phục phân tán dữ liệu, hình thành nguồn dữ liệu dùng chung, thống nhất phục vụ quản lý nhà nước và cung cấp dịch vụ số',
    users:
      'Lực lượng Công an, cán bộ xử lý nghiệp vụ, cơ quan nhà nước, người dân và tổ chức có liên quan',
    process:
      'Theo danh mục chính thức; quy trình nghiệp vụ cụ thể do cơ quan chủ quản/chủ trì xác định khi triển khai, vận hành',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Lưu trữ và quản lý thông tin về năng lực của tổ chức và cá nhân tham gia hoạt động xây dựng trên toàn quốc',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Là các thành phần hạ tầng dữ liệu quan trọng trong hệ thống chuyển đổi số và quản lý nhà nước',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Hệ thống thông tin dùng để thu thập, quản lý và khai thác dữ liệu về hạ tầng giao thông như đường bộ, cầu, cảng, bến… phục vụ quản lý nhà nước và quy hoạch phát triển giao thông',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Xây dựng kho dữ liệu ngành giáo dục tập trung, hỗ trợ thống kê, báo cáo và điều hành ngành của Sở GD&ĐT',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Quản lý nợ',
    problem:
      'Lập kế hoạch, phân khai/điều chỉnh kế hoạch vốn (KHV); Huy động vốn và kiểm soát KHV; Theo dõi giải ngân của dự án, GTGC, nhận nợ; Trả nợ; Báo cáo, đối chiếu số liệu.',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'Khắc phục phân tán dữ liệu, hình thành nguồn dữ liệu dùng chung, thống nhất phục vụ quản lý nhà nước và cung cấp dịch vụ số',
    users:
      'Doanh nghiệp bảo hiểm, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đại lý bảo hiểm',
    process:
      'Theo danh mục chính thức; quy trình nghiệp vụ cụ thể do cơ quan chủ quản/chủ trì xác định khi triển khai, vận hành',
    cat: 'chinh_quyen',
    field: 'du_lieu',
  ...
  },
  {
    ...
    dev: 'Tập đoàn VNPT',
    problem:
      'Hệ thống Cơ sở dữ liệu quốc gia về chăn nuôi (sau đây gọi tắt là Hệ thống) do Cục Chăn nuôi và Thú y - Bộ Nông nghiệp và Môi trường xây dựng, triển khai và vận hành. Hệ thống là nền tảng dữ liệu số tập',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Phần mềm phục vụ thu thập, xử lý các dữ liệu về giá hàng hóa, dịch vụ; dữ liệu về thẩm định giá; thông tin quản lý Nhà nước về giá.',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Hệ thống thông tin dùng để thu thập, lưu trữ, quản lý và chia sẻ dữ liệu về các hoạt động xây dựng trên phạm vi toàn quốc',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tư pháp',
    users:
      'Cơ quan tư pháp, cán bộ xử lý nghiệp vụ, người dân, doanh nghiệp và tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bộ Công an',
    problem:
      'Khắc phục phân tán dữ liệu, hình thành nguồn dữ liệu dùng chung, thống nhất phục vụ quản lý nhà',
  ...
  },
  {
    ...
    problem:
      'theo dõi, đánh giá và phân tích tình hình đầu tư trên toàn quốc. Mục đích chính bao gồm phục vụ công tác quản lý nhà nước, hỗ trợ nhà đầu tư trong hoạt động kinh doanh, và quản lý các chương trình mục tiêu quốc gia',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    users:
      'Doanh nghiệp sản xuất, nhà máy, bộ phận vận hành, kỹ thuật, quản lý chất lượng và lãnh đạo doanh nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'san_xuat',
  ...
  },
  {
    ...
    dev: 'Viện Khoa học Tổ chức nhà nước và Lao động',
    problem:
      'Cập nhật các thông tin, dữ liệu (sách, báo, tạp chí, kỷ yếu…) phục vụ nghiên cứu khoa học của viện',
    users:
      'Cơ quan báo chí, nhà xuất bản, đài phát thanh - truyền hình, đơn vị sản xuất nội dung và người dùng nội dung số',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Sử dụng để quản lý dữ liệu về Tổ chức giám định và quản lý dữ liệu về giám định máy móc, thiết bị, dây chuyền công nghệ đã qua sử dụng',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Hiện đại hóa quản lý nhà nước, cải cách thủ tục hành chính, phục vụ xây dựng Chính phủ số và kinh tế số. CSDL này tổng hợp thông tin từ thuế, hải quan, bảo hiểm và các nguồn khác để phục vụ điều hành, dự báo và ra quyết định tài chính',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'Cung cấp khả năng tra cứu, tìm kiếm dưới dạng điện tử các loại văn bản sau: Văn bản quy phạm pháp luật do Bộ Tài chính ban hành; Văn bản hợp nhất; Văn bản điều hành; Văn bản quy phạm pháp luật thu thập từ nguồn Công báo Chính phủ.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      '1. Sử dung cho việc xử lý phản ành khiếu nại của người tiêu dùng 2. hỗ trợ nghe gọi cho tổng đài viên 3. Sử dụng để quản lý máy chủ và hệ thống mạng nội bộ của cơ quan. Hỗ trợ quản lý tài khoản, phân quyền truy cập và chia sẻ dữ liệu',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'NEAC',
    problem:
      'Trung tâm lưu trữ và khai thác thông tin dữ liệu tập trung, nền tảng cho việc số hóa quy trình làm việc, nâng cao tính minh bạch, hiệu quả và bảo mật trong công tác quản lý dịch vụ chứng thực chữ ký số',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    problem:
      'Tổng hợp các dữ liệu về giá phục vụ cho quá trình tổng hợp, phân tích, báo cáo, truy xuất dữ liệu',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Công khai danh sách người phải thi hành án chưa có điều kiện thi hành án, đảm bảo quyền tiếp cận thông tin của cá nhân, tổ chức theo quy định pháp luật',
    users:
      'Cơ quan báo chí, nhà xuất bản, đài phát thanh - truyền hình, đơn vị sản xuất nội dung và người dùng nội dung số',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Hệ thống thông tin dùng để lưu trữ, quản lý và cung cấp dữ liệu liên quan đến chi phí và tiêu chuẩn trong hoạt động xây dựng',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Khắc phục tình trạng dữ liệu đất phân tán, thiếu đồng bộ, khó tra cứu và khai thác trong công tác nghiên cứu và quản lý',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần CyStack Việt Nam',
    problem:
      'Doanh nghiệp Việt Nam đối mặt với nhiều thách thức về an toàn thông tin trong quá trình chuyển đổi số: tấn công mạng gia tăng, lỗ hổng bảo mật trên ứng dụng web và di động ngày càng phức tạp, yêu cầu tuân thủ pháp luật (Luật An ninh mạng, Nghị định',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ an toàn thông tin, quản trị hệ thống và bộ phận công nghệ thông tin',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương; Khoa học và Công nghệ',
    users:
      'Doanh nghiệp sản xuất, nhà máy, bộ phận vận hành, kỹ thuật, quản lý chất lượng và lãnh đạo doanh nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nông nghiệp và Môi trường; Giáo dục và Đào tạo',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần Thành Thành Công - Biên Hòa',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương; Hoạt động viễn thông; lập trình máy tính, tư vấn, cơ sở hạ tầng máy tính và các dịch vụ thông tin khác.',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'chinh_quyen',
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Hạn chế tối đa làm giả, khai khống; Ký số mọi lúc mọi nơi 24/7; Chống chối bỏ trách nhiệm, yên tâm giao dịch.',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp cổng dịch vụ công trực tuyến và cơ chế một cửa điện tử, giúp cá nhân và tổ chức giải quyết thủ tục hành chính online',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    problem:
      'Tin học hoá và tự động hoá quy trình kê khai, nộp hồ sơ và xử lý thủ tục bảo hiểm xã hội cho doanh nghiệp',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Cho phép người dùng ký tài liệu điện tử mọi lúc, mọi nơi mà không cần USB token; Quản lý thuận tiện: Người dùng truy cập lịch sử giao dịch đầy đủ, tức thời; Tích hợp dễ dàng.',
    users:
      'Cơ quan tư pháp, cán bộ xử lý nghiệp vụ, người dân, doanh nghiệp và tổ chức có liên quan',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT Media',
    problem:
      'dựa trên tập thông tin khách hàng chuẩn hóa cung cấp xác thực thông tin khách hàng; chấm điểm tín dụng khách hàng dựa trên thông tin của khách hàng; cung cấp tệp khách hàng tiềm năng.',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
  ...
  },
  {
    ...
    dev: 'VNPT - Media',
    problem:
      'kiểm tra tính đúng đắn của thông tin khách hàng trên các ứng dụng bên thứ 3 dựa trên dữ liệu viễn thông đã xác thực với C06; đánh giá và xếp hạng khách hàng cho các ngân hàng/tổ chức tín dụng dựa trên dữ liệu viễn thông của người dùng',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nông nghiệp và Môi trường; Xây dựng',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin MobiFone',
    problem:
      'Chi phí đầu tư lớn: Loại bỏ gánh nặng chi phí mua sắm, bảo trì phần cứng và vận hành trung tâm dữ liệu vật lý cho doanh nghiệp; Thiếu linh hoạt trong mở rộng: Khắc phục tình trạng quá tải hoặc lãng phí tài nguyên nhờ khả năng tăng/giảm quy mô hạ tầng tức t hì theo nhu cầu thực tế',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực khoa học và Công nghệ',
    users: 'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin và quản trị hệ thống',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Số hóa 2D/3D, AR/VR toàn bộ di sản văn hóa và tài nguyên du lịch tỉnh, xây dựng kho dữ liệu di sản số toàn diện',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Cung cấp tài nguyên tính toán (RAM, vCPU, Storage, IP, OS) như server vật lý một cách linh hoạt, theo nhu cầu sử dụng, đảm bảo an toàn, hiệu quả cho các ứng dụng CNTT',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực văn hóa, Thể thao và Du lịch; Giáo dục và Đào tạo',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Tổng công ty giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp Nền tảng bán hàng B2B kết nối từ doanh nghiệp tới đại lý trực tiếp, cho phép Đối tượng người dùng đại lý (retailer)',
    users:
      'Doanh nghiệp bán buôn, bán lẻ, nhà cung cấp, bộ phận kinh doanh và khách hàng mua sắm, tiêu dùng',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng công ty giải pháp doanh nghiệp Viettel',
    problem:
      'Quản lý toàn bộ kênh phân phối từ nhà sản xuất đến nhà phân phối và đại lý, tự động hóa và tối ưu hóa bán hàng thị trường',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng công ty giải pháp doanh nghiệp Viettel',
    problem:
      'Tự động đánh giá và chấm điểm trưng bày sản phẩm tại điểm bán bằng AI xử lý hình ảnh thay thế kiểm tra thủ công',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    problem:
      'Cung cấp công cụ phân tích dữ liệu DMS và báo cáo thông minh (BI), hỗ trợ ra quyết định kinh doanh dựa trên dữ liệu',
    users:
      'Doanh nghiệp bán buôn, bán lẻ, nhà cung cấp, bộ phận kinh doanh và khách hàng mua sắm, tiêu dùng',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Hệ thống hỗ trợ du khách xuyên suốt hành trình khám phá - từ tìm hiểu, lập kế hoạch đến trải nghiệm và chia sẻ - qua đó nâng cao chất lượng trải nghiệm và gia tăng mức độ hài lòng của du khách thông qua ứng dụng các công nghệ',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ số hóa, tối ưu hóa hoạt động dạy học, quản lý lớp học và triển khai học tập trực tuyến trong lĩnh vực giáo dục',
    users:
      'Học sinh, sinh viên, giáo viên, cơ sở giáo dục và đơn vị đào tạo trong lĩnh vực giáo dục',
    process:
  ...
  },
  {
    ...
    problem:
      '1. SIEM: Giải pháp giải quyết bài toán thiếu tầm nhìn toàn diện về an ninh hạ tầng và sự quá tải dữ liệu log khiến các chuyên gia không thể xử lý thủ công. SIEM giúp loại bỏ các "điểm mù" bằng cách tổng hợp dữ liệu từ nhiều nguồn khác nhau, giảm thiểu tỷ l ệ cảnh báo sai (false positive) thông qua các kịch bản tương quan thông minh',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ an toàn thông tin, quản trị hệ thống và bộ phận công nghệ thông tin',
    process:
  ...
  },
  {
    ...
    dev: 'CÔNG TY TNHH CÔNG NGHỆ EZCLOUD TOÀN CẦU',
    problem:
      'Các khách sạn và chuỗi khách sạn tại Việt Nam, đặc biệt các chuỗi khi mở rộng quy mô, gặp bài toán phân phối và quản lý đặt phòng phức tạp mà một phần mềm quản lý đơn lẻ không đáp ứng được: (i)',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương; Giáo dục và Đào tạo',
    users:
      'Doanh nghiệp sản xuất, nhà máy, bộ phận vận hành, kỹ thuật, quản lý chất lượng và lãnh đạo doanh nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực giáo dục và đào tạo',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Trung tâm Dịch vụ dữ liệu và Trí tuệ nhân tạo Viettel',
    problem:
      'Tự động nhận diện biển số xe cung cấp dịch vụ cho các trường hợp: Các hệ thống thu phí không dừng; Quản lý các bãi giữ ô tô, xe máy; Quản lý phương tiện ra vào kho hàng, trụ sở cơ quan.',
    users:
      'Doanh nghiệp vận tải, logistics, đơn vị quản lý kho bãi/cảng, lái xe, nhân viên vận hành và khách hàng sử dụng dịch vụ',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tài chính; Giáo dục và Đào tạo',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tài chính; Công Thương',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Trung tâm Dịch vụ dữ liệu và Trí tuệ nhân tạo Viettel',
    problem:
      'Tự động hóa việc kiểm duyệt nội dung để giảm thiểu công việc của quản trị viên nội dung, gia tăng trải nghiệm người dùng; Nội dung lành mạnh được phát hành sớm nhất có thể và đồng thời giúp ngăn chặn kịp thời nội dung xấu theo các quy định hiện hành của ph áp luật Việt Nam',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Phát hiện những bất thường trong mạng; Nhanh chóng cô lập, xử lý sự cố; Hỗ trợ quá trình điều tra truy vết; Quản lý chính sách, phần mềm bản quyền.',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
  ...
  },
  {
    ...
    dev: 'Mobi fone, VNPT',
    problem:
      'Hiện nay, cấp xã/phường còn thiếu đồng bộ trong chuyển đổi số, hệ thống CNTT chưa được phân cấp an toàn, tiềm ẩn rủi ro bảo mật và khó khăn trong quản lý, vận hành; Hoạt động giáo dục, thông tin tuyên truyền và cung cấp dịch vụ công còn hạn chế về ứng dụng công nghệ , thiếu tính tương tác và kịp',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực chuyển đổi số',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực giáo dục và Đào tạo; Hoạt động viễn thông; lập trình máy tính, tư vấn, cơ sở hạ tầng máy tính và các dịch vụ thông tin khác.',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Trung tâm Dịch vụ dữ liệu và Trí tuệ nhân tạo Viettel',
    problem:
      'Quản lý vào ra và chấm công sử dụng AI nhận diện khuôn mặt để xác định danh tính và ghi nhận thời gian ra, vào của người lao động',
    users:
      'Cơ quan quản lý đô thị, chủ đầu tư, doanh nghiệp xây dựng/bất động sản, đơn vị vận hành và người dân/cư dân',
    process:
  ...
  },
  {
    ...
    dev: 'MBBank',
    problem:
      'Giao dịch doanh nghiệp phát sinh phân tán, thiếu tập trung, khó kiểm soát; Tổng hợp chi phí lẻ tẻ, nhỏ của doanh nghiệp còn thủ công; Chưa có phương án tín dụng dự phòng, tiết kiệm chi phí vốn.',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực sản phẩm, giải pháp dùng chung',
    users:
      'Doanh nghiệp, lãnh đạo quản lý, bộ phận tài chính - kế toán, nhân sự, kinh doanh và vận hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Số hóa 3D toàn bộ tài nguyên du lịch trên bản đồ số, phân loại điểm đến và tích hợp chỉ đường, hướng dẫn tham quan',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực ngân hàng; Hoạt động tài chính, ngân hàng và bảo hiểm',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Giải pháp giải quyết nhu cầu chấp nhận thanh toán không tiền mặt và số hóa hoạt động thu - chi tại điểm bán và dịch vụ công, giúp các đơn vị kinh doanh và cơ quan nhà nước triển khai thu phí, bán hàng, thanh toán đa phương thức một cách thuận tiện, minh bạ ch và dễ quản lý',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    problem:
      'Áp dụng hỗ trợ giảng dạy trong trường lớp cũng như dùng để minh hoạ trong các hoạt động của workshop hay demo liên quan',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tài chính; Giáo dục và Đào tạo',
    users:
      'Doanh nghiệp, trung tâm chăm sóc khách hàng, bộ phận kinh doanh, bộ phận hỗ trợ và khách hàng sử dụng dịch vụ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
    field: 'giao_duc',
  },
  {
    ...
    problem:
      'Sản phẩm tổng đài VNPT ICC giải quyết trực tiếp các vấn đề vận hành CSKH mà nhiều cơ quan/đơn vị đang gặp phải: - Tình trạng phân mảnh kênh giao tiếp (điện thoại, email, web, mạng xã hội) khiến thông tin bị rời rạc, khó theo dõi lịch sử tương tác. - Quá tả i tổng',
    users:
      'Doanh nghiệp, trung tâm chăm sóc khách hàng, bộ phận kinh doanh, bộ phận hỗ trợ và khách hàng sử dụng dịch vụ',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Đảm bảo an toàn thông tin (ATTT) cho hệ thống cấp độ 2; Kiểm soát ứng dụng để ngăn chặn nội dung xấu, độc',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Cung cấp hạ tầng và nền tảng GPU H200 hiệu năng cao, phục vụ các tác vụ huấn luyện (training) và suy luận (inference) mô hình AI quy mô lớn cho khách hàng',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ người lái xe quan sát, cảnh báo và nâng cao an toàn trong quá trình điều khiển phương tiện',
    users:
      'Người lái xe, doanh nghiệp vận tải, đơn vị quản lý đội xe và người dùng có nhu cầu hỗ trợ lái xe an toàn',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Ứng dụng CNTT vào quy trình quản lý hành chính và cung cấp dịch vụ công trực tuyến cấp độ 4 của Cục Quản lý Dược',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    problem:
      'Hệ sinh thái "Bản sao số (Digital Twin) Tương tác thông minh 3D/360 tích hợp Trợ lý ảo AI" của Star Global được phát triển nhằm giải quyết một cách toàn diện các hạn chế cốt lõi của thế giới thực, đồng',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    users:
      'Doanh nghiệp bất động sản, tổ chức tài chính, nhà đầu tư, khách hàng và đơn vị môi giới bất động sản',
    process:
  ...
  },
  {
    ...
    problem:
      'Giúp giảm thời gian thực hiện báo cáo qua các tính năng tự động tổng hợp dữ liệu theo các kỳ báo cáo; Tăng tính năng chính xác của số liệu báo cáo bằng các kiểm tra về kiểu dữ liệu, kiểm tra về ràng buộc dữ liệu, hỗ trợ liên kết dữ liệu giữa các báo cáo',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Viễn thông',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tài chính',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Dịch vụ dữ liệu và Trí tuệ nhân tạo Viettel',
    problem:
      'Tổng đài tự động gọi cho khách hàng; Đầu vào: Danh sách sđt và kịch bản gọi; Đầu ra: Hệ thống tổng đài tự động gọi điện đến người dùng theo kịch bản tương ứng.',
    users:
      'Doanh nghiệp, trung tâm chăm sóc khách hàng, bộ phận kinh doanh, bộ phận hỗ trợ và khách hàng sử dụng dịch vụ',
    process:
  ...
  },
  {
    ...
    problem:
      'Lắp đặt hệ thống Camera AI an ninh trên địa bàn xã để đảm bảo an toàn giao thông, phục vụ an ninh trật tự, xử lý vi phạm hành chính trên địa bàn xã',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nông',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'Giải pháp nhằm khắc phục tình trạng phát hiện cháy rừng chậm, thiếu thông tin kịp thời, khó dự báo nguy cơ cháy và hạn chế trong công tác chỉ huy, điều hành; từ đó giúp phát hiện sớm, cảnh báo nhanh và',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng để cung cấp dịch vụ tổng đài hỗ trợ khách hàng (Call Center)',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Vấn đề thực tiễn là giúp thoát nước đô thị trong vùng phố cổ phố cổ có mật độ cao khó thay đổi thoát',
    users:
      'Doanh nghiệp vận tải, logistics, đơn vị quản lý kho bãi/cảng, lái xe, nhân viên vận hành và',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Viễn thông',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tài chính; Hoạt động viễn thông; lập trình máy tính, tư vấn, cơ sở hạ tầng máy tính và các dịch vụ thông tin khác.',
    users:
      'Cơ quan tài chính, cán bộ xử lý nghiệp vụ, doanh nghiệp, tổ chức và người dân có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'tai_chinh',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng để cung cấp dịch vụ chứng thực chữ ký số chuyên dùng cho',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả',
  ...
  },
  {
    ...
    dev: 'VTT - Tập đoàn Viettel',
    problem:
      'Tin học hoá và tự động hoá quy trình ký duyệt văn bản, hồ sơ điện tử; đảm bảo tính xác thực, toàn vẹn và chống chối bỏ trong giao dịch điện tử',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
  ...
  },
  {
    ...
    problem:
      'Hệ thống để thực hiện báo cáo và công bố thông tin bằng hình thức điện tử theo quy định của pháp luật về công bố thông tin trên thị trường chứng khoán',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Trung tâm R&D',
    problem:
      'Quản lý cơ sở dữ liệu về cán bộ, công chức, viên chức của Đài TNVN, phục vụ công tác quản lý nhân sự, theo dõi thông tin và thực hiện các nghiệp vụ liên quan trong hệ thống',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, tạo lập kênh cung cấp và trao đổi thông tin, dịch vụ công trực tuyến của Ngành; hỗ trợ tích cực cho việc thực hiện cải cách hành chính, tạo thuận tiện cho người dân và đơn vị sử dụng lao động trong gia o dịch với cơ quan BHXH',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'cung cấp thông tin phục vụ hoạt động điều hành của Chính phủ, Thủ tướng Chính phủ, Cung cấp thư điện tử công vụ cho cán bộ VPCP',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống CSDL Danh mục Dùng chung thực hiện quản lý, lưu trữ và cập nhật Danh mục điện tử Dùng chung trong toàn Hệ thống KBNN và tại một số đơn vị trong và ngoài ngành Tài chính. Hệ thống CSDL Danh mục Dùng chung nhằm định nghĩa các Danh mục dữ liệu thống nhất của KBNN mà bất kỳ Hệ thống nào khi xây dựng đều phải sử dụng tạo thuận tiện trong việc thống kê, báo cáo và quản lý dữ liệu,',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Ủy ban Chứng khoán Nhà nước',
    problem:
      'Quản lý, giám sát về hoạt động của công ty chứng khoán; trên thị trường chứng khoán Việt Nam',
    users:
      'Cơ quan báo chí, nhà xuất bản, đài phát thanh - truyền hình, đơn vị sản xuất nội dung và người dùng nội dung số',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Ủy ban Chứng khoán Nhà nước',
    problem:
      'Quản lý, giám sát quá trình hoạt động của người hành nghề chứng khoán trên thị trường chứng khoán Việt Nam',
    users: 'Ngân hàng, tổ chức tài chính, doanh nghiệp và khách hàng cá nhân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Ủy ban Chứng khoán Nhà nước',
    problem:
      'Quản lý, giám sát về hoạt động của nhà đầu tư nước ngoài; trên thị trường chứng khoán Việt Nam',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Quản lý văn bản điện tử; Quản lý toàn bộ dữ liệu của các cơ sở giáo dục; Quản lý thư viện; Quản lý đào tạo; Đào tạo từ xa.',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Hệ thống dịch vụ công của các bộ/ngành được kết nối vào hệ thống trung tâm để doanh nghiệp chỉ cần nộp hồ sơ một lần khi thực hiện thủ tục liên quan đến xuất nhập khẩu, vận tải, logistics',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống Dịch vụ công trực tuyến (DVCTT) được KBNN bắt đầu triển khai từ năm 2016, đã cung cấp 9 thủ tục hành chính trong lĩnh vực KBNN trên môi trường trực tuyến liên quan đến lĩnh vực kiểm soát chi NSNN, đăng ký và sử dụng tài khoản theo Nghị định số 11/ 2020/NĐ - CP ngày',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Công nghệ thống tin',
    problem:
      'Cho phép doanh nghiệp và cá nhân thực hiện các thủ tục hành chính trong lĩnh vực vận tải đường bộ qua Internet',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, thay thế giấy tờ, cải cách hành chính, sử dụng chung để quản lý, lưu trữ, cập nhật các thông tin về hồ sơ giao dịch giữa cơ',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng/HTTT phục vụ hoạt động nội bộ/Quản lý hệ thống báo cáo và kết quả chấm điểm báo cáo phục vụ công tác thi đua nội bộ của CTK',
    users: 'Cơ quan nội vụ, cán bộ, công chức, viên chức và cơ quan, tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'xác định nhanh loài gỗ và hỗ trợ xác minh nguồn gốc gỗ trong các hoạt động thương mại, quản lý, kiểm tra và thực thi pháp luật',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
  ...
  },
  {
    ...
    problem:
      'Giải quyết nhu cầu giảm tải cho cán bộ giải quyết thủ tục hành chính, cán bộ quản lý vận hành hệ thống tại cấp xã',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Kịp thời tiếp nhận và phản hồi, chính sách, tháo gỡ và giải đáp vướng mắc cho cán bộ trong cơ quan liên quan tới các lĩnh vực quản lý. - Toàn bộ quy trình',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Xúc tiến thương mại',
    problem:
      'Gửi và nhận thư điện tử cho cán bộ công chức, viên chức người lao động thuộc Cục XTTM',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Xây dựng hồ sơ sức khỏe điện tử (EHR) cho từng người dân, lưu trữ suốt đời và chia sẻ an toàn giữa cơ sở y tế',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực y tế; Y tế và hoạt động trợ giúp xã hội',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'xa_hoi',
  ...
  },
  {
    ...
    dev: 'VTT - Tập đoàn Viettel',
    problem:
      'Số hóa quy trình giao kết, ký kết và lưu trữ thông qua phương tiện điện tử, có giá trị pháp lý tương đương với văn bản truyền thống',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
  ...
  },
  {
    ...
    dev: 'VNPT AI',
    problem:
      '1. Khó khăn trong quản lý và kết nối nhân sự phân tán Các tổ chức/doanh nghiệp có nhiều chi nhánh hoặc nhân sự làm việc từ xa cần',
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng/HTTT phục vụ hoạt động nội bộ/Thiết lập kết nối và truyền đưa, lưu trữ thông tin hình ảnh trực tuyến giữa các điểm cầu đăng nhập phục vụ các cuộc họp trực tuyến',
    users: 'Cơ quan nội vụ, cán bộ, công chức, viên chức và cơ quan, tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng/HTTT cở sở hạ tầng thông tin/Kết nối, chia sẻ dữ liệu về đối tượng nộp thuế với Cục Thuế',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Trung tâm Chứng thực điện tử quốc gia',
    problem:
      'Thu thập số liệu và quản lý dịch vụ chứng thực chữ ký số công cộng đáp ứng các quy định mới tại Luật giao dịch điện tử 2023, các quy định khác về dịch vụ chứng thự chữ ký sốthu thập số liệu và quản lý dịch vụ chứng thực chữ ký số công cộng đáp ứng các quy định mới tại Luật giao dịch điện tử 2023, các quy định khác',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin và chuyển đổi số',
    problem:
      'LGSP của Bộ Tài chính, phục vụ kết nối, chia sẻ dữ liệu giữa các đơn vị thuộc Bộ Tài chính',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ; ngân hàng, tổ chức tài chính, doanh nghiệp và khách hàng cá nhân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'tai_chinh',
  },
  {
    ...
    dev: 'Ủy ban Chứng khoán Nhà nước',
    problem:
      'Trao đổi, cung cấp thông tin, dữ liệu quản lý thuế và thông tin, dữ liệu quản lý trong lĩnh vực chứng khoán liên quan đến yêu cầu quân lý Nhà nước của mỗi bên',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống Kho dữ liệu thống kê, phân tích hoạt động nghiệp vụ (KDL) là hệ thống thông tin cấp độ 3, được KBNN triển khai từ năm 2018 đã giúp tập trung dữ liệu của các hệ thống ứng dụng phục vụ hoạt động nghiệp vụ của KBNN như TABMIS, TTĐT - NH, TCS đáp ứng ch ế độ kế toán NSNN theo',
    users: 'Ngân hàng, tổ chức tài chính, doanh nghiệp và khách hàng cá nhân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng chung để khai thác, phân tích, báo cáo, thống kê tổng hợp từ CSDL các hệ thống ứng dụng nghiệp vụ chuyên ngành',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống kiểm soát chi đầu tư qua KBNN (ĐTKB - GD) được KBNN triển khai từ năm 2021, là hệ thống hỗ trợ cho công tác kiểm soát chi các dự án đầu tư công theo kế hoạch vốn hàng năm, tổng mức đầu tư dự án, theo hạng mục, hợp đồng (tiết mục). Hệ thống là cơ sở để KBNN lập các báo cáo đầu ra theo quy định của Thông tư 15/2021/TT - BTC và Thông tư 96/2021/TT - BTC phục vụ công tác lãnh đạo, chỉ đạo điều hành của Chính',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Giải pháp giúp số hóa hoạt động du lịch, đáp ứng nhu cầu truy cập internet tốc độ cao và tra cứu thông tin du lịch trực quan cho khách tham quan tại các khu vực rộng lớn, từ đó nâng cao trải nghiệm của du khách và thúc đẩy chuyển đổi số ngành du lịch tỉnh Ninh Bình',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
  ...
  },
  {
    ...
    dev: 'Mobifone Hải Phòng',
    problem:
      'Nâng cao chất lượng nội dung thông tin để cung cấp, trao đổi thông tin theo hướng kịp thời, chủ động, chính xác và hiệu quả',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Lưu trữ, quản lý và phân phối hình ảnh y tế chuyên dụng (DICOM), hỗ trợ chẩn đoán hình ảnh và hội chẩn từ xa',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Viện Kiểm sát nhân dân tối cao',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nội vụ; Hoạt động viễn thông; lập',
    users: 'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng/HT cơ sở hạ tầng/Là mạng tập trung cho các dịch vụ và kho dữ liệu tại các trụ sở chính, phân tán các ứng dụng xuống cấp dưới',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Quản lý đấu thầu',
    problem:
      'quản lý thông tin, đấu thầu qua mạng, đảm bảo công khai, minh bạch và hiệu quả kinh tế trong mua sắm công. Hệ thống hỗ trợ đăng tải thông tin dự án, nộp hồ sơ dự thầu, lựa chọn nhà thầu, nhà đầu tư, tra cứu kết quả và tiết kiệm chi phí',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Tự động nhắc lịch tiêm chủng cho người dân theo phác đồ Bộ Y tế, đảm bảo tiêm chủng đúng hạn và đầy đủ',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Đăng kiểm Việt Nam',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương; Hoạt động hành chính và dịch vụ hỗ trợ',
    users:
      'Doanh nghiệp sản xuất, nhà máy, bộ phận vận hành, kỹ thuật, quản lý chất lượng và lãnh đạo doanh nghiệp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Học viện Công nghệ Bưu chính Viễn thông',
    problem:
      'Thống kê số liệu toàn học viện, các nhiệm vụ KHCN, báo cáo, tầm nhìn, chiến lược phát triển',
    users: 'Cơ quan, tổ chức, doanh nghiệp, cán bộ quản trị và người dùng nội bộ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Vietbando',
    problem:
      'Dữ liệu đất đai phân tán, lưu trữ thủ công, thiếu đồng bộ; Khó khăn trong cập nhật biến động và',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế,',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Đăng kiểm Việt Nam',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực hoạt động của Đảng Cộng sản, tổ chức chính trị - xã hội, quản lý nhà nước, an ninh quốc phòng; bảo đảm xã hội bắt buộc',
    users:
      'Người dân, doanh nghiệp, cơ quan nhà nước và cán bộ tiếp nhận, xử lý thủ tục hành chính',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tư pháp; Hoạt động của Đảng Cộng sản, tổ chức chính trị - xã hội, quản lý nhà nước, an ninh quốc phòng; bảo đảm xã hội bắt buộc.',
    users:
      'Cơ quan quản lý đô thị, chủ đầu tư, doanh nghiệp xây dựng/bất động sản, đơn vị vận hành và người dân/cư dân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Quản lý khám chữa bệnh còn thủ công, phân tán, thiếu liên thông dữ liệu; Khó khăn trong quản lý viện phí, BHYT và quyết toán; Thiếu dữ liệu tổng hợp phục vụ điều hành, báo cáo; Chưa đáp ứng yêu cầu chuyển đổi số và tiêu chí',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần Tin học Tân Dân',
    problem:
      'Giúp lãnh đạo và cán bộ đơn vị theo dõi được tiến độ và quá trình thực hiện nhiệm vụ, công việc mình đã giao và được giao; Hỗ trợ lãnh đạo, cán bộ tại đơn vị giải quyết công việc hàng ngày, vấn đề phát sinh hay giải quyết, ứng phó sự cố theo quy trình, kịc h bản điều hành được xây dựng sẵn trên hệ thống',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng chung để Quản lý thông tin về người dùng, thông tin danh mục dùng chung. Phục vụ công tác giám sát, quản trị và kiểm soát truy cập của các tài khoản vào hệ thống phần mềm nghiệp vụ ngành BHXH V iệt Nam',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý, lưu trữ tập trung tại Trung tâm dữ liệu ngành BHXH Việt Nam để hỗ trợ cán bộ, Lãnh đạo',
  ...
  },
  {
    ...
    problem:
      'Xây dựng trang thông tin dữ liệu nông sản thành phố nhằm cung cấp miễn phí thông tin công khai về nông sản cho người dân; hỗ trợ cơ sở sản xuất, kinh doanh nông sản quảng bá, giới thiệu sản phẩm, quản lý và tra cứuthông tin sản phẩm, nhật ký sản xuất; hỗ t rợ thông tin thị trường, xúc tiến thương mại, kết nối hợp tác.',
    users:
      'Nông dân, hợp tác xã, doanh nghiệp nông nghiệp, cán bộ kỹ thuật và cơ quan quản lý ngành nông nghiệp',
    process:
  ...
  },
  {
    ...
    dev: 'Thông tấn xã Việt Nam',
    problem:
      'Số hóa, lưu trữ và quản lý toàn diện hồ sơ, quá trình công tác, lương, thi đua khen thưởng cán bộ công chức TTXVN',
    users:
      'Doanh nghiệp du lịch, cơ sở lưu trú, điểm đến du lịch, cơ quan quản lý du lịch và du khách',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần Tin học Tân Dân',
    problem:
      'Việc áp dụng LMS giúp nâng cao chất lượng đào tạo, tiết kiệm chi phí, chuẩn hóa quy trình quản lý và xây dựng môi trường học tập hiện đại',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, sử dụng để cung cấp phục vụ hoạt động nội bộ của Ngành BHXH Việt Nam liên quan đến việc kiểm tra tiếp công dân của Ngành',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng và thông tin cá nhân/HTTT phục vụ hoạt động nội bộ/Quản lý nội bộ hồ sơ các công chức, viên chức ngành Thống kê',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, hồ sơ hành chính điện tử hình thành từ kết quả thực hiện nghiệp vụ, giao dịch điện tử tại các hệ thống như: quản lý văn bản và điều hành, giao dịch điện tử, hệ thống nghiệp vụ chuyên ngành',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực nội vụ; Hoạt động của Đảng Cộng sản, tổ chức chính trị - xã hội, quản lý nhà nước, an ninh quốc phòng; bảo đảm xã hội bắt buộc.',
    users: 'Cơ quan nội vụ, cán bộ, công chức, viên chức và cơ quan, tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần Tin học Tân Dân',
    problem:
      'Kích cầu tiêu dùng, kết nối nhanh chóng giữa người cần mua và người cần bán giúp phát triển kinh tế tư nhân, kinh tế hộ gia đình tại địa phương',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Dự trữ Nhà nước',
    problem:
      'Hệ thống Quản lý nghiệp vụ DTQG đã đáp ứng một số mục tiêu như sau: Quản lý tình hình kho dự trữ; Quản lý danh mục hàng, phân bố, số lượng, giá trị hàng DTQG; Quản lý công tác nhập, xuất hàng DTQG;',
    users: 'Ngân hàng, tổ chức tài chính, doanh nghiệp và khách hàng cá nhân',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Quản lý tổng thể hoạt động nhà thuốc, quầy thuốc (danh mục, kho, bán hàng) và đồng bộ dữ liệu với hệ thống dược quốc gia',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn ngành BHXH Việt Nam, thay thế giấy tờ, cải cách hành chính, sử dụng chung để quản lý',
    users:
      'Người lao động, người sử dụng lao động, cơ quan bảo hiểm xã hội và cán bộ xử lý hồ sơ bảo hiểm xã hội',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả',
  ...
  },
  {
    ...
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin và quản trị hệ thống; cơ quan nội vụ, cán bộ, công chức, viên chức và cơ quan, tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'doanh_nghiep',
  ...
  },
  {
    ...
    dev: 'Cục Quản lý nợ',
    problem:
      'Hỗ trợ quản lý nợ công của Chính phủ, giám sát các rủi ro tài chính từ các nghĩa vụ nợ của doanh nghiệp Nhà nước; Hỗ trợ phát triển việc ghi chép nợ trong nước và quản lý rủi ro trong Chính phủ cũng như việc tổng hợp tổng thể công tác quản lý nợ thông qua giao diện với TABMIS',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Cục Công nghệ thống tin',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Công ty Cổ phần Tin học Tân Dân',
    problem:
      'Số hóa, quản lý tập trung tài sản; Kiểm soát chặt chẽ vòng đời tài sản; Chuẩn hóa quy trình nghiệp vụ; Công khai, minh bạch thông tin tài sản; Nâng cao trách nhiệm của cán bộ',
    users:
      'Cơ quan tài chính, cán bộ xử lý nghiệp vụ, doanh nghiệp, tổ chức và người dân có liên quan',
    process:
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống quản lý thu NSNN (TCS) được KBNN triển khai theo mô hình tập trung từ năm 2011, đáp ứng nhu cầu quản lý thu, hoàn thu NSNN qua Kho bạc; nhận chứng từ, thông tin thu NSNN từ các Ngân hàng Thương mại; trao đổi thông tin thu, hoàn thu NSNN với cơ qua n Tài chính, Thuế, Hải quan; trao đổi thông tin thu NSNN với Cổng dịch vụ công Quốc gia. Hàng năm, hệ thống TCS xử lý trên 30 triệu chứng thừ thu, hoàn thu NSNN.',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem: 'Xử lý nghiệp vụ của đơn vị',
    users:
      'Cơ quan văn hóa, bảo tàng, thư viện, đơn vị quản lý di sản, người dân và khách tham quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'du_lich',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Quản lý toàn diện hoạt động trường học (học sinh, giáo viên, điểm số, chuyên cần) cho hệ thống giáo dục từ mầm non đến THPT',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    problem:
      'Tập trung quản lý nhiệm vụ KH&CN toàn quốc trên cùng 1 nền tảng; Thay thế quy trình quản lý hồ sơ giấy truyền thống vốn chậm trễ và dễ thất lạc; Chuyển đổi số và nâng cao hiệu quả quản lý; Minh bạch hóa việc tuyển chọn và xét duyệt nhiệm vụ thông qua hội đồng chuyên gia; Tổng hợp dữ liệu và báo cáo thống kê tình hình nghiên cứu khoa học trên phạm vi cả nước.',
    users: 'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin và quản trị hệ thống',
    process:
  ...
  },
  {
    ...
    problem:
      'Nền tảng điện tử dùng để quản lý và cấp chứng nhận xuất xứ (C/O) cho hàng hóa xuất khẩu. Giúp cơ quan chức năng kiểm soát và quản lý thông tin liên quan đến xuất xứ hàng hóa dễ dàng hơn. Đồng thời giúp doanh nghiệp xuất khẩu giảm bớt thủ tục không cần thiế t để chứng nhận xuất xứ cho hàng hóa xuất khẩu',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    problem:
      'Quản lý văn bản, hệ thống thanh toán kho bạc, thu học phí, xuất hóa đơn điện ử, quản lý đào tạo, quản lý tài liệu, thu nhận hồ sơ giấy phép lái xe, quản lý học tập trực tuyến',
    users:
      'Doanh nghiệp, lãnh đạo quản lý, bộ phận tài chính - kế toán, nhân sự, kinh doanh và vận hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Phục vụ công tác quản lý, chỉ đạo, điều hành,; trao đổi văn bản điện tử; Phục vụ công tác quản lý, chỉ đạo, điều hành,; trao đổi văn bản điện tử; Phục vụ công tác quản lý, chỉ đạo, điều hành,; trao đổi văn bản điện tử; Kê khai Bảo hiểm xã hội trực tuyến.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'xử lý công việc, theo dõi các nhiệm vụ của Chính phủ, Thủ tướng Chính phủ, phục vụ hoạt động điều',
    users: 'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    dev: 'Bộ Nông nghiệp và Môi trường',
    problem:
      'Cung cấp một số chức năng chuyên dụng cho các cấp lãnh đạo như: phân phối văn bản đến, phân công xử lý văn bản đến; phê duyệt, ký số, xác thực ký số; và cung cấp một số chức năng cơ bản khác cho mọi người dùng hệ thống như: tra cứu, tìm kiếm văn bản, lịch công tác, trao đổi trực tuyến.',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    problem:
      'Xóa bỏ rào cản địa lý: Lãnh đạo có thể ký duyệt văn bản mọi lúc, mọi nơi qua thiết bị di động; Tiết kiệm chi phí: Giảm thiểu tối đa chi phí in ấn, giấy tờ, bưu chính và thời gian luân chuyển văn bản vật lý; Minh bạch hóa: Theo dõi được chính xác trạng thái xử lý văn bản, biết được văn bản đang "tắc" ở khâu nào, cán bộ nào; Lưu trữ khoa học: Tra cứu hồ sơ, văn bản cũ chỉ trong vài giây thay vì phải tìm kiếm trong kho lưu trữ giấy.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
  ...
  },
  {
    ...
    problem:
      'Giảm phụ thuộc vào xử lý văn bản giấy; Rút ngắn thời gian trình ký, luân chuyển hồ sơ; Tăng tính minh bạch, theo dõi và truy vết xử lý công việc; Nâng cao hiệu quả điều hành, quản trị nội bộ.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
  ...
  },
  {
    ...
    dev: 'Bảo hiểm xã hội Việt Nam',
    problem:
      'Quản lý tập trung thống nhất toàn Ngành, thay thế giấy tờ, cải cách hành chính, sử dụng chung để quản lý các văn bản pháp lý, công văn, hồ sơ, văn bản gửi nhận và điều hành trong ngành BHXH được gửi nhận qua các đơn vị, tổ chức khác nhau được quản lý lưu l ại và tra cứu tập',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'VNPT',
    problem:
      'Số hóa và tự động hóa quy trình xử lý văn bản; Theo dõi, giám sát tiến độ theo thời gian thực; Lưu trữ tập trung, tra cứu nhanh; Giảm chi phí, tăng hiệu quả điều hành; Hỗ trợ ký số, làm việc mọi lúc mọi nơi; Kết nối liên thông trong hệ sinh thái chính quyề n số.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
  ...
  },
  {
    ...
    problem:
      'Quản lý văn bản (đến, đi, nội bộ) một cách tập trung, thống nhất; Tự động hóa quy trình xử lý công việc: trình ký, phê duyệt, giao việc, theo dõi tiến độ; Tăng hiệu quả điều hành: lãnh đạo xem, duyệt văn bản mọi lúc mọi nơi; theo dõi được tình trạng công v iệc; Giảm giấy tờ, tránh thất lạc hồ sơ, nâng cao tính minh bạch và trách nhiệm của từng cá nhân.',
    users:
      'Cơ quan, tổ chức, cán bộ, công chức, viên chức và người lao động tham gia xử lý hồ sơ, văn bản, điều hành',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'VNPT - IT',
    problem:
      'Quản lý y tế cơ sở còn thủ công, thiếu đồng bộ dữ liệu; Khó khăn trong quản lý hồ sơ sức khỏe người dân; Thiếu công cụ theo dõi y tế dự phòng, tiêm chủng, bệnh không lây nhiễm; Báo cáo thống kê còn chậm, thiếu chính xác; Chưa liên thông dữ liệu với tuyến t rên và Bộ Y tế.',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Quản lý khám chữa bệnh và báo cáo thống kê y tế tuyến xã/phường, trạm y tế và phòng khám quy mô nhỏ',
    users: 'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin cá nhân/HT cơ sở hạ tầng thông tin/Quản lý định danh, xác minh danh tính điện tử và thực hiện chữ ký số của người sử dụng; giải pháp xác thực đăng nhập, đăng xuất một lần',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực công Thương; Sản xuất và phân phối điện, khí đốt, nước nóng, hơi nước và điều hòa không khí',
    users:
      'Đơn vị điện, nước, năng lượng, cơ quan quản lý chuyên ngành, doanh nghiệp vận hành hạ tầng và khách hàng sử dụng dịch vụ',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
    field: 'san_xuat',
  },
  {
    ...
    dev: 'Bộ Tư pháp',
    problem:
      'Hỗ trợ chuẩn hóa quy trình, quản lý thông tin và nâng cao hiệu quả xử lý công việc trong lĩnh vực tư pháp; Nông nghiệp và Môi trường',
    users:
      'Cơ quan tư pháp, cán bộ xử lý nghiệp vụ, người dân, doanh nghiệp và tổ chức có liên quan',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Tổng Công ty Giải pháp doanh nghiệp Viettel',
    problem:
      'Quản lý toàn bộ hoạt động đào tạo, sinh viên, học vụ và tài chính học phí cho trường đại học và cao đẳng',
    users: 'Học sinh, sinh viên, giáo viên, phụ huynh, cơ sở giáo dục và đơn vị đào tạo',
    process:
  ...
  },
  {
    ...
    dev: 'Cục Thống kê',
    problem:
      'Thông tin riêng và thông tin cá nhân/HT cơ sở hạ tầng thông tin/Sao lưu dữ liệu các dự án được triển khai tại TTXL (Hà Nội), TTXL (Hồ Chí Minh), TTXL (Đà Nẵng), sao lưu hệ thống mail của CTK; Thực hiện phục hồi dữ liệu sau khi khắc phục các sự cố tại TTXL (Hà Nội)',
    users:
      'Cơ quan, tổ chức, doanh nghiệp, đội ngũ công nghệ thông tin, quản trị hệ thống và nhà phát triển ứng dụng',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Kho bạc Nhà nước',
    problem:
      'Hệ thống Thanh toán điện tử với ngân hàng (TTĐT - NH) là hệ thống thông tin cấp độ 3, được KBNN triển khai qua nhiều giai đoạn, bắt đầu từ năm 2013. Hệ thống TTĐT - NH đáp ứng nhu cầu thanh toán cho các đối tượng thụ hưởng cũng',
    users:
      'Ngân hàng, tổ chức tài chính, khách hàng cá nhân, khách hàng doanh nghiệp và đơn vị chấp nhận thanh toán',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
  ...
  },
  {
    ...
    dev: 'Ban Tuyên giáo và Dân vận Trung ương',
    problem:
      'Tạo các phiếu điều tra theo yêu cầu; Tổ chức các cuộc điều tra cho các thành phần tham gia theo mẫu phiếu trên internet qua các nền tảng trực tuyên',
    users: 'Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu cầu sử dụng sản phẩm, giải pháp',
    process:
      'Người dùng khởi tạo yêu cầu hoặc dữ liệu đầu vào; hệ thống tiếp nhận, xử lý, lưu trữ và cung cấp kết quả phục vụ quản lý, khai thác hoặc sử dụng dịch vụ',
    cat: 'kinh_te',
  ...
  },
  {
    ...
    users:
      'Cơ sở y tế, bác sĩ, nhân viên y tế, cơ quan quản lý y tế, người bệnh và người dân Cơ quan, tổ chức, doanh nghiệp và người dùng có nhu',
    process:
