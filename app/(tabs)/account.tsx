      ...
      <ScrollView contentContainerStyle={ls.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={ls.card}>
          ...
          <Text style={ls.cardSub}>
            Đăng nhập để đánh giá và nhận xét sản phẩm
          </Text>
        ...
        {[
          ...
          <Pressable
            ...
            onPress={() => { setEmail(a.email); setPassword(a.pw); setError(''); }}>
...
function ProfileView() {
  ...
  const doLogout = async () => { setBusy(true); await logout(); };
        ...
        {[
          ...
          <View key={label}>
            <View style={pv.row}>
              ...
              <Text style={pv.rowV} numberOfLines={1}>{value}</Text>
            </View>
...
export default function AccountScreen() {
  ...
  return (
    <SafeAreaView style={ss.safe} edges={['top']}>
      ...
      {loading
        ? <View style={ss.center}><ActivityIndicator size="large" color="#1C1C1E" /></View>
        : user ? <ProfileView /> : <LoginForm />}
    </SafeAreaView>
  );
}
...
const ls = StyleSheet.create({
  ...
  logoIcon: { width: 72, height: 72, borderRadius: 18, backgroundColor: '#1C1C1E', alignItems: 'center', justifyContent: 'center' },
  logoTitle: { fontSize: 20, fontWeight: '800', color: '#0A0A0A', letterSpacing: -0.3 },
  logoSub: { fontSize: 13, color: '#8E8E93' },

  card: { backgroundColor: '#fff', borderRadius: 20, padding: 20, gap: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  cardTitle: { fontSize: 22, fontWeight: '800', color: '#0A0A0A', letterSpacing: -0.3 },
  cardSub: { fontSize: 13, color: '#8E8E93', marginTop: -8 },

  errorBox: { flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: '#FFF0EF', padding: 10, borderRadius: 10 },
  errorTxt: { fontSize: 13, color: '#CC1400', flex: 1 },

  fieldWrap: { gap: 6 },
  label: { fontSize: 13, fontWeight: '700', color: '#6B6B6B' },
  inputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F5F5F5', borderRadius: 12, paddingHorizontal: 12, height: 46, gap: 8, borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  input: { flex: 1, fontSize: 15, color: '#0A0A0A' },

  btn: { backgroundColor: '#f5bf23', borderRadius: 14, height: 50, alignItems: 'center', justifyContent: 'center', marginTop: 4 },
  ...
  demoTitle: { fontSize: 13, fontWeight: '700', color: '#8E8E93', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 24, marginBottom: 10 },
  demoRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, padding: 14, marginBottom: 8, gap: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  demoIcon: { width: 40, height: 40, borderRadius: 10, backgroundColor: '#F5F5F5', alignItems: 'center', justifyContent: 'center' },
  demoTexts: { flex: 1 },
...
const pv = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#1C1C1E', alignItems: 'center', justifyContent: 'center' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: '800', color: '#0A0A0A', letterSpacing: -0.3, marginTop: 20, marginBottom: 10 },
  card: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  ...
  logoutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, marginTop: 28, backgroundColor: '#fff', borderRadius: 14, paddingVertical: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: '#F5C6C6' },
