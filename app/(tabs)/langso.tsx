    ...
    <SafeAreaView style={ss.safe} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={ss.scroll}>
        ...
        <View style={ss.header}>
          <Image source={{ uri: LOGO_TITLE_URL }} style={ss.logoTitle} contentFit="contain" />
        </View>
        ...
        <View style={ss.hero}>
          ...
          <Text style={ss.heroSub}>
            Ứng dụng công nghệ số để thay đổi thói quen sinh hoạt, tư duy sản xuất và phát triển
        ...
        <View style={ss.pillarsWrap}>
          {PILLARS.map((p, i) => (
            <View key={i} style={ss.pillarRow}>
              <Image source={{ uri: p.image }} style={ss.pillarImg} contentFit="contain" />
        ...
        <View style={ss.chuyen}>
          ...
          <Text style={ss.chuyenBody}>
            Chia sẻ để nhân rộng câu chuyện về cách người dân tại các địa phương khắp cả nước đang
            ứng dụng công nghệ để thay đổi diện mạo làng quê, tự tin làm giàu trên chính quê hương
            mình.
          </Text>
        </View>
        ...
        <View style={ss.quote}>
          ...
          <View style={ss.quoteInner}>
            <Text style={ss.quoteTxt}>
              "Người dân nông thôn là chủ thể chính của chuyển đổi số — không chỉ là đối tượng thụ
              hưởng."
            </Text>
