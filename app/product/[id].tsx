...
import {
  Pressable, ScrollView, Share, StatusBar, StyleSheet, Text, View,
} from 'react-native';
...
function InfoBlock({ icon, title, body }: { icon: React.ComponentProps<typeof Feather>['name']; title: string; body: string }) {
  ...
  return (
    <View style={ib.wrap}>
      ...
      <View style={ib.inner}>
        ...
        <Text style={ib.body} numberOfLines={expanded ? undefined : 5}>{body}</Text>
        {long && (
...
export default function ProductScreen() {
  ...
  return (
    <View style={ss.root}>
        ...
        <SafeAreaView edges={['top']}>
          ...
          <View style={ss.heroBody}>
            ...
            <View style={ss.heroTexts}>
              ...
              <Text style={ss.heroName} numberOfLines={3}>{product.name}</Text>
              <Text style={ss.heroDev} numberOfLines={2}>{product.dev || cfg.label}</Text>
            </View>
          </View>
      ...
      {/* ── CONTENT ── */}
      <ScrollView style={ss.scroll} contentContainerStyle={ss.pad} showsVerticalScrollIndicator={false}>

        {/* Horizontal strip */}
        <View style={ss.strip}>
          <View style={ss.stripItem}>
            <VIcon name={cfg.icon} size={20} color="#6B6B6B" />
            <Text style={ss.stripVal} numberOfLines={2}>{cfg.label}</Text>
...
const ib = StyleSheet.create({
  wrap: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0', flexDirection: 'row' },
  accent: { width: 4, backgroundColor: '#f5bf23' },
  inner: { flex: 1, padding: 16, gap: 10 },
  header: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  title: { fontSize: 13, fontWeight: '800', color: '#6B6B6B', textTransform: 'uppercase', letterSpacing: 0.4, flex: 1 },
...
const ss = StyleSheet.create({
  ...
  nav: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: 8, paddingBottom: 16 },
  backBtn: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  backTxt: { fontSize: 16, color: 'rgba(255,255,255,0.85)', fontWeight: '400' },

  heroBody: { flexDirection: 'row', alignItems: 'flex-start', paddingHorizontal: 20, paddingBottom: 20, gap: 16 },
  iconWrap: { width: 88, height: 88, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.1)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)', flexShrink: 0 },
  heroTexts: { flex: 1, paddingTop: 4, gap: 6 },
  catPill: { flexDirection: 'row', alignItems: 'center', gap: 5, alignSelf: 'flex-start', backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: 10, paddingHorizontal: 9, paddingVertical: 4, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(255,255,255,0.18)' },
  catPillTxt: { fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.7)', letterSpacing: 0.3 },
  ...
  ctaBtn: { flex: 1, backgroundColor: '#f5bf23', borderRadius: 13, paddingVertical: 11, alignItems: 'center' },
  ctaBtnTxt: { fontSize: 14, fontWeight: '700', color: '#0A0A0A' },
  ctaShare: { width: 46, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 13, paddingVertical: 11, alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(255,255,255,0.15)' },

  scroll: { flex: 1 },
  pad: { padding: 16, gap: 12 },

  strip: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 16, paddingVertical: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  stripItem: { flex: 1, alignItems: 'center', gap: 5, paddingHorizontal: 8 },
  stripVal: { fontSize: 11, fontWeight: '700', color: '#0A0A0A', textAlign: 'center', lineHeight: 15 },
  ...
  relatedCard: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  relatedTitle: { fontSize: 15, fontWeight: '800', color: '#0A0A0A', letterSpacing: -0.2, paddingHorizontal: 18, paddingTop: 15, paddingBottom: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#F0F0F0' },

  notFound: { flex: 1, backgroundColor: '#F5F5F5', alignItems: 'center', justifyContent: 'center', gap: 12 },
  nfTitle: { fontSize: 17, color: '#8E8E93', fontWeight: '600' },
  nfBtn: { backgroundColor: '#1C1C1E', borderRadius: 12, paddingHorizontal: 24, paddingVertical: 11 },
  nfBtnTxt: { color: '#fff', fontSize: 15, fontWeight: '700' },
});

/* ── RatingsBlock styles ── */
const rb = StyleSheet.create({
  wrap: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E0E0E0' },
  sectionTitle: { fontSize: 15, fontWeight: '800', color: '#0A0A0A', letterSpacing: -0.2, paddingHorizontal: 18, paddingTop: 16, paddingBottom: 14, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#F0F0F0' },

  summary: { flexDirection: 'row', paddingHorizontal: 18, paddingVertical: 16, gap: 20, alignItems: 'center' },
  ...
  writeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, marginHorizontal: 16, marginVertical: 4, backgroundColor: '#f5bf23', borderRadius: 12 },
  writeTxt: { fontSize: 14, fontWeight: '700', color: '#0A0A0A' },

  loginPrompt: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, paddingVertical: 14 },
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#1C1C1E', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  helpfulBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingVertical: 4, paddingHorizontal: 8, backgroundColor: '#F5F5F5', borderRadius: 12 },
